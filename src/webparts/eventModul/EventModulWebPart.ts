...
export default class EventModulWebPart extends BaseClientSideWebPart<IEventModulWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IEventModulProps> = React.createElement(
      EventModul,
      {
